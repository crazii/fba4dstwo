...
unsigned char *GalS2650Rom1          = NULL;
...
unsigned int   GalS2650Rom1Size      = 0;
unsigned int   GalS2650Rom1Num       = 0;
...
int GalFrame()
{
	...
	if (!GalUseAltZ80 && GalZ80Rom1Size) ZetNewFrame();
