...
/*
	Known issues:
		bestbest: 
			missing all sounds, YM3526 is not emulated

		bssoccer:
			some scrolling issues on left side of screen ?
			shows up in MAME, non-bug?
*/
